/*
    Стартуем БФС или ДФС от первой вершины, оно обозначает все связанные с ней вершины, потом ищем необозначенную вершину и стартуем от неё БФС и т.д.
    Кол-во запусков БФС - ответ.
*/
